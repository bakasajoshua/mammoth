...
ALTER TABLE `report_mammoth`.`reports` 
ADD COLUMN `created_at` TIMESTAMP(0) NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `report_mammoth`.`report_content` 
ADD COLUMN `created_at` TIMESTAMP(0) NULL DEFAULT CURRENT_TIMESTAMP;

ALTER TABLE `report_mammoth`.`reports` 
ADD COLUMN `updated_at` TIMESTAMP(0) NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `report_mammoth`.`report_content` 
ADD COLUMN `updated_at` TIMESTAMP(0) NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP;

ALTER TABLE `report_mammoth`.`reports` 
ADD COLUMN `status_desc` VARCHAR(45) NULL;

ALTER TABLE `report_mammoth`.`reports` 
ADD COLUMN `deadline` VARCHAR(45) NULL;
