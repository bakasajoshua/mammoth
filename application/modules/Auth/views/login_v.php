...
<head>
  ...
  <link rel="stylesheet" href="<?= @$this->config->item('assets_url'); ?>plugins/iCheck/square/blue.css">

</head>
<body class="hold-transition login-page">
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Report </b>Manager</a>
  </div>
  <!-- /.login-logo -->
...
<!-- iCheck -->
<script src="<?= @$this->config->item('assets_url'); ?>plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
