...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="<?= @$this->config->item('assets_url'); ?>index2.html" class="logo">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?= @$this->session->userdata('fulname'); ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p><?= @$this->session->userdata('fulname'); ?></p>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2016 <a href="http://almsaeedstudio.com">Marewill Studio</a>.</strong> All rights
    reserved.
  </footer>
...
<!-- SlimScroll -->
<script src="<?= @$this->config->item('assets_url'); ?>plugins/slimScroll/jquery.slimscroll.min.js"></script>
<!-- FastClick -->
<script src="<?= @$this->config->item('assets_url'); ?>plugins/fastclick/fastclick.js"></script>
<!-- AdminLTE App -->
